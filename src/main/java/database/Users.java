...
public class Users {
    ...
    public static int choiceStep(){

        System.out.println("Hello here you can create/read/delete new user in data base \n" +
                "For create user enter - 1" + "\n"+
                "For read data base enter - 2"+ "\n"+
                "For delete user enter - 3.");
