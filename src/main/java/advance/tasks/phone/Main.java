...
public class Main {
    ...
    private static MobilePhone mobilePhone = new MobilePhone("+372 56342323");
...
//                bug fix
    ...
    private  static void addNewContact(){
        ...
        if (mobilePhone.addNewContact(newContact)){
            ...
            System.out.println("Cannot add contact with name " + name + " or "+ phone + " because it already exist in the contact list" );
        }

//        System.out.println("Add to favorites Y/N");
//        String choice = scanner.nextLine().toLowerCase();
//        if (choice.equals("y")){
//            Group.FAVORITES.equals(newContact);
//        }else{
//            Group.OTHER.equals(newContact);
//        }
