...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (again=='y'){
            ...
            System.out.println("4 - Java Core");
    ...
    private static void loop(){
        ...
        while(questions.size() > 0){
            ...
            if(input < 0 || input > currentQuestion.getRightAnswer().length()){
        ...
        System.out.println("You " + score + " questions right.");
    }
    ...
    private static void addQuestion(int number) {
        ...
        try{
            ...
            System.out.println("Please enter first 1. answer as correct one");
            ...
            // Writing in file new line question text
            br.write("\n" + q.getText());
